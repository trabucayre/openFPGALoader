...
set_property PACKAGE_PIN AM26     [get_ports "sdi_sec_dq0"];
set_property IOSTANDARD  LVCMOS18 [get_ports "sdi_sec_dq0"];
set_property PACKAGE_PIN AN26     [get_ports "sdo_sec_dq1"];
set_property IOSTANDARD  LVCMOS18 [get_ports "sdo_sec_dq1"];
set_property PACKAGE_PIN AL25     [get_ports "wpn_sec_dq2"];
set_property IOSTANDARD  LVCMOS18 [get_ports "wpn_sec_dq2"];
set_property PACKAGE_PIN AM25     [get_ports "hldn_sec_dq3"];
set_property IOSTANDARD  LVCMOS18 [get_ports "hldn_sec_dq3"];
set_property PACKAGE_PIN BF27     [get_ports "csn_sec"];
