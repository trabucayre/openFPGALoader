...
static std::map <std::string, target_board_t> board_list = {
	...
	JTAG_BOARD("alinx_axku042",   "xcku040-ffva1156",     "digilent_hs2", SPI_FLASH, 0, 0, CABLE_DEFAULT),
	JTAG_BOARD("alinx_axku062",   "xcku060-ffva1156",     "digilent_hs2", SPI_FLASH, 0, 0, CABLE_DEFAULT),
	...
	JTAG_BOARD("blackboard",      "xc7z007sclg400",       "ft2232",       SPI_FLASH, 0, 0, CABLE_MHZ(3)),
	...
	JTAG_BOARD("kr260",           "xck26",                "digilent_ft4232", SPI_FLASH, 0, 0, CABLE_DEFAULT),
